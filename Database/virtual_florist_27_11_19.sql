...
--
-- Host: 127.0.0.1
-- Czas generowania: 27 Lis 2019, 13:05
...
--
-- Zrzut danych tabeli `monthly_status`
--

INSERT INTO `monthly_status` (`monthly_status_id`, `date`, `income`, `products_sold`) VALUES
(1, '2019-11-26', 0, 0),
(2, '2019-11-27', 0, 0),
(3, '2019-11-27', 0, 0),
(4, '2019-11-27', 0, 0),
...
--
ALTER TABLE `monthly_status`
  MODIFY `monthly_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
-- Zdarzenia
--
CREATE DEFINER=`root`@`localhost` EVENT `e_hourly` ON SCHEDULE EVERY 1 HOUR STARTS '2019-11-26 23:43:10' ON COMPLETION NOT PRESERVE ENABLE COMMENT 'Clears out sessions table each hour.' DO INSERT INTO `monthly_status`( `date`, `income`, `products_sold`) VALUES (CURRENT_DATE,'0','0')$$
